function BootstrapCtrl ($scope, $rootScope, $http, I18n, Tracker) {
	...
	var prod = {
			user : user,
			urls : {
				jobstack : 'http://cloud-bigdata.com/BigDataJobStack'
			}
	};
	
	$rootScope.trakerService = Tracker;
	$rootScope.trakerService.connected(false);
